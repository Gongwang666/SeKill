...
<link href="jdms/css/dlstyle.css" rel="stylesheet" type="text/css">
<script type="text/javascript" src="assets/js/jquery-2.1.0.js"></script>
</head>
<body>
	<div class="login-boxtitle">
		<a href="home.html"><img alt="logo" src="jdms/images/logobig.png" /></a>
	</div>

	<div class="login-banner">
		<div class="login-main">
			<div class="login-banner-bg">
				<span></span><img src="jdms/images/big.jpg" />
			</div>
			<div class="login-box">
				...
				<div class="am-cf">
					<input id="submit-btn" type="submit" name="" value="登 录"
