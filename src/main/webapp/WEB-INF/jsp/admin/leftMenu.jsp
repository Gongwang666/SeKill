				    ...
				    <div class="am-offcanvas-bar admin-offcanvas-bar">
	                    ...
	                    <!-- End User -->
						 ...
						 <ul class="am-list admin-sidebar-list">
						    <li><a href="admin/toIndex"><span class="am-icon-home"></span> 首页</a></li>
						    ...
						    <li class="admin-parent">
						      <a class="am-cf" data-am-collapse="{target: '#collapse-nav2'}"><i class="am-icon-line-chart" aria-hidden="true"></i> 订单管理 <span class="am-icon-angle-right am-fr am-margin-right"></span></a>
						      <ul class="am-list am-collapse admin-sidebar-sub am-in" id="collapse-nav2">
						        <li><a href="adminOrderController/listAllOrder?page=1" class="am-cf"> 订单管理</span></a></li>
						      </ul>
						    </li>
						    <li class="admin-parent">
						      <a class="am-cf" data-am-collapse="{target: '#collapse-nav5'}"><span class="am-icon-file"></span> 数据统计 <span class="am-icon-angle-right am-fr am-margin-right"></span></a>
						      <ul class="am-list am-collapse admin-sidebar-sub am-in" id="collapse-nav5">
						        <li><a href="statistics/toChartPage" class="am-cf"> 统计图</a></li>
						        <li><a href="statistics/toSaleDetailPage">销售明细</a></li>   
						      </ul>
						    </li>
						  </ul>
				</div>
