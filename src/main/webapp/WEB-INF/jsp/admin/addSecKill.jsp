					...
					<!-- Row start -->
						<div class="am-u-sm-10">
							<div class="card-box">
								...
								<form action="admin/seckill/add.do" class="am-form" method="post" name="secKill" id="doc-vld-msg" data-am-validator >
								  <fieldset>
									<legend>添加秒杀任务</legend>
									 <label for="doc-vld-name-2">开始时间：</label>
								     <div class="am-input-group input-group" id='startTime'>
									  <input name="starttime" value="2017-06-02 14:45:00" class="am-form-field">
								     ...
								     <div class="am-input-group input-group" id='endTime'>
									  <input name="endtime" value="2017-06-02 14:45:00" class="am-form-field">
									  <!--注意添加  datepickerbutton class-->
									  <span class="am-input-group-label datepickerbutton">
									    <i class="icon-th am-icon-calendar"></i>
									  </span>
									 ...
									 <div class="am-form-group">
								      ...
								      <input name="name" type="text" id="doc-vld-name-1" minlength="2" placeholder="输入秒杀活动名称" required/>
								    </div>
									 <div class="am-form-group">
								      <label for="doc-vld-name-2">价格：</label>
								      <input name="price" type="text" id="doc-vld-name-2" minlength="2" placeholder="输入秒杀价格" required/>
								    </div>
								    <div class="am-form-group">
								      <label for="doc-vld-name-3">总数：</label>
								      <input name="totalcount" type="text" id="doc-vld-name-3" minlength="2" placeholder="输入秒杀总数" required/>
								    </div>
								    ...
								    <input id="secGid" name="goods.gid" type="hidden" />
		...
		$(function() {
	    	...
	    	$('#doc-dropdown-toggle').bind('input propertychange',function(e) {
	    		var val = $('#doc-dropdown-toggle').val();
	    			$.ajax({
	    			  	url:"admin/seckill/search.do?str="+val,
	    				type:"post",
	    				dataType:"json",
	    				success:function(data){
	    					$(".am-dropdown-content").html("");
	    					for(var i = 0;i<data.length;i++){
	    						$(".am-dropdown-content").append("<li class='click' data-gid='"+data[i].gid+"'>"+data[i].gname+"</li>");
	    					}
	    					$(".click").on("click",function(){
	    						$(".am-dropdown-content").html("");
	    						$("#secGid").val($(this).data("gid"));
	    						$('#doc-dropdown-toggle').val($(this).text());
	    					});
